    ...
    <div className="min-h-screen bg-[#1a1b23] font-sans text-slate-200 pb-24 md:pb-6 overflow-x-hidden">
      {isDemo && (
        <div className="bg-amber-500 px-4 py-3 text-center text-[10px] md:text-xs font-black uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg sticky top-0 z-[60] text-slate-900">
           ...
           <button onClick={() => setIsDemo(false)} className="underline decoration-2 underline-offset-4 ml-2 hover:text-black transition-colors">Sign in to set up your own system &rarr;</button>
        </div>
      )}
                ...
                <div onClick={() => isDemo && setIsDemo(false)}>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <input 
                      ...
                      placeholder={isDemo ? "Sign in to log..." : (needsEntry ? "Enter final kWh..." : "0.0")} 
                    />
