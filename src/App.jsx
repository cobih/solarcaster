...
export default function App() {
  ...
  const STRING_COLORS = ['#f59e0b', '#ef4444', '#10b981', '#3b82f6', '#8b5cf6', '#ec4899']; // Note: These will stay hex for Recharts but should match config
  ...
  const renderTooltipContent = ({ active, payload, label }) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-[#1e293b] border border-slate-700 p-3 rounded-lg shadow-xl text-[10px] space-y-2">
  ...
  if ((loading || dbSyncing) && data.length === 0) return <div className="flex items-center justify-center h-screen bg-solar-bg text-white"><div className="text-center animate-pulse"><Sun className="w-12 h-12 text-[#fde047] mx-auto mb-4" /><h2 className="text-xl font-semibold text-slate-400">Loading Solar Physics...</h2></div></div>;
