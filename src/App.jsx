        ...
        {activeTab === 'today' && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className={`bg-gradient-to-br from-[#1e293b] to-[#0f172a] p-5 rounded-xl border shadow-sm flex flex-col justify-between transition-all duration-500 ${needsEntry && !isDemo ? 'border-amber-500/50 ring-2 ring-amber-500/20 shadow-[0_0_15px_rgba(16,185,129,0.1)]' : 'border-indigo-500/30'} ${isDemo ? 'opacity-50 cursor-not-allowed' : ''}`}>
